...
```cmd
python src\descargar_bcrp.py
python src\limpiar_datos.py
python src\analizar_datos.py
python src\generar_json.py
```

Copiar el JSON generado a la carpeta pública:

```cmd
copy data\output\datos_dashboard.json docs\data\datos_dashboard.json
```
